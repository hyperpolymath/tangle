...
# setup.sh — Universal setup script for tangle
#
...
main() {
    ...
    if [ ! -f "Justfile" ] && [ ! -f "justfile" ]; then
        ...
        info "Clone first: git clone https://github.com/hyperpolymath/tangle.git"
        info "Then: cd tangle && ./setup.sh"
        exit 1
    fi
