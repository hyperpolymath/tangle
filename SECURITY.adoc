...
[arabic]
. Navigate to
https://github.com/hyperpolymath/tangle/security/advisories/new[Report a
Vulnerability]
...
https://github.com/hyperpolymath/tangle/security/advisories[Security
Advisories]
...
|Purpose |Contact
|*Security issues*
|https://github.com/hyperpolymath/tangle/security/advisories/new[Report
via GitHub] or j.d.a.jewell@open.ac.uk

|*General questions*
|https://github.com/hyperpolymath/tangle/discussions[GitHub Discussions]
...
_Thank you for helping keep tangle and its users safe._ 🛡️
