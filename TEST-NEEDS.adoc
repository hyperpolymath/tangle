...
|*Source modules* |11 |Rust: ast, ast_jtv, lexer, parser, parser_jtv,
eval, lib, main, sexpr + 3 Idris2 ABI

|*Unit tests (inline)* |252 |lexer=151, parser=40, parser_jtv=32,
eval=29
...
|*Benchmarks* |4 files |bench_lexer.rs (135L), bench_parser_rust.rs
(106L), bench_lexer.ml (113L), bench_parser.ml (88L)
...
* [ ] *Error handling*: No tests for error recovery, partial parse,
unterminated strings

==== Build & Execution

* [ ] OCaml benchmarks (bench_lexer.ml, bench_parser.ml) – does OCaml
build config exist?
...
* *ast.rs, ast_jtv.rs, sexpr.rs have 0 tests* – structural modules
untested
* *No integration/E2E despite having eval* – can’t verify programs
