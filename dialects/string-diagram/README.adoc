...
* Type checking beyond domain/codomain matching (would need TypeLL for
that)
...
morphisms are crossings/caps/cups. KRL’s `+close+`, `+tensor+`,
`+mirror+` operations correspond to categorical operations on string
diagrams.
