...
Compositional quantum-circuit calculus. Quantum gates map naturally to
Tangle’s compositional operations (sequential = gate-in-time, parallel =
gate-in-space via tensor product).
