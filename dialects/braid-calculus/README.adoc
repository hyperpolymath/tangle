...
A direct surface language for working in Artin braid groups Bₙ. Distinct
from KRL by being narrower: braids only, no closure, no knot
...
* `+../../../krl/+` — knot resolution language (consumes braid words via
`+close+`)
